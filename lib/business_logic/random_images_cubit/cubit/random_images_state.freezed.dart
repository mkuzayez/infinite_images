...
part of 'random_images_state.dart';
...
class __$$LoadingMoreImplCopyWithImpl<T, $Res>
    extends _$ResultStateCopyWithImpl<T, $Res, _$LoadingMoreImpl<T>>
...
class _$LoadingMoreImpl<T> implements LoadingMore<T> {
  ...
  @override
  String toString() {
    return 'ResultState<$T>.loadingMore()';
  }
...
abstract class LoadingMore<T> implements ResultState<T> {
  const factory LoadingMore() = _$LoadingMoreImpl<T>;
}
